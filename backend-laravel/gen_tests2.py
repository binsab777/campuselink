...
class JobParityTest extends TestCase {
    ...
    protected function setUp(): void {
        ...
        Recruiter::create(['user_id' => $this->recruiterUser->id, 'company_id' => $company->id, 'contact_email' => 't1@test.com']);
        ...
        Recruiter::create(['user_id' => $this->otherRecruiter->id, 'company_id' => $company2->id, 'contact_email' => 't2@test.com']);
    }
...
class DriveParityTest extends TestCase {
    ...
    protected function setUp(): void {
        ...
        $this->recruiterUser = User::factory()->create(['role' => UserRole::RECRUITER->value]);
        $company = Company::create(['name' => 'Tech Corp', 'description' => 'A tech company']);
        Recruiter::create(['user_id' => $this->recruiterUser->id, 'company_id' => $company->id, 'contact_email' => 't3@test.com']);
    }
